...
- Usage warnings and limits visualization (backend ready)
...
- ✅ Real-time calculation of weekly time usage (backend API ready)
- ✅ Shared time pool management between users
- ⏳ Usage warnings when approaching or exceeding weekly limits (frontend removed)
- ⏳ Visual progress bars and status indicators (planned for future)
- ⏳ Interactive usage dashboard with booking details (planned for future)
